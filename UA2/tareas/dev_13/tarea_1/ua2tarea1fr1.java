...
public class ua2tarea1fr1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-------------------------------");
        System.out.println("Hilos: Tarea 1 con bloques no sincronizados");
        System.out.println("-------------------------------");
        ...
        System.out.println("--------------------------------------");
        System.out.println("Como se puede observar cada vez que se ejecuta el programa\n el resultado es aleatorio. El resultado debería de ser \n 5000");
        System.out.println("--------------------------------------");
        timer.stop();
