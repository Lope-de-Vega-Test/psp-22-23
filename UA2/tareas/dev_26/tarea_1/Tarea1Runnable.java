...
public class Tarea1Runnable {
    public static void main(String[] args) {
        System.out.println("----------------------------");
        System.out.println("Hilos: Interfaz Runnable");
        System.out.println("----------------------------");
        ...
        try {
            Thread(hiloSuma[0]).join();
            Thread(hiloSuma[1]).join();
            Thread(hiloSuma[2]).join();
            Thread(hiloSuma[3]).join();
            Thread(hiloSuma[4]).join();
        }
