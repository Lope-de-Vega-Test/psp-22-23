...
public class Tarea1U4 extends JFrame {
    ...
    static JTextField ventana = new JTextField();
	...
	// constructor
	public Tarea1U4() throws IOException {
				...
				if (!(nombreCarpeta==null)) {
					...
					try {
						if (cliente.makeDirectory(directorio)) {
							String m= nombreCarpeta.trim()	+ " Creada correctamente ...";
