...
//TODAS LAS PRUEBAS REALIZADAS EN EL SERVIDOR FTP PUBLICO ftp.rediris.es
public class Tarea1 extends JFrame {
    ...
    //Añadimos esta linea con un JTextField para solicitar el servidor FTP
	static JTextField serveFTP= new JTextField();
	...
	public Tarea1() throws IOException {
        ...
        //añadimos nuestro TextField para solicitar el servidor FTP
		add(serveFTP);
