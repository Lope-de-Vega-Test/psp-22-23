...
public class ua4tarea1Grafico extends JFrame {
    ...
    JButton botonConexion = new JButton("Crear conexion");
    ...
    // constructor
    public ua4tarea1Grafico() throws IOException {
        super("ua4tarea1 en entorno grafico");
        ...
        cab.setBounds(new Rectangle(5, 5, 340, 30));
        cab.setBorder(null);
        ...
        direccion.setBounds(new Rectangle(350, 50, 140, 30));
        botonConexion.setBounds(new Rectangle(350, 100, 140, 30));
        botonCargar.setBounds(new Rectangle(350, 150, 140, 30));
        botonDescargar.setBounds(new Rectangle(350, 200, 140, 30));
        botonBorrar.setBounds(new Rectangle(350, 250, 140, 30));
        botonCreaDir.setBounds(new Rectangle(350, 300, 140, 30));
        botonDelDir.setBounds(new Rectangle(350, 350, 140, 30));
        botonSalir.setBounds(new Rectangle(350, 400, 140, 30));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (!servidor.isBlank()) {
                        ...
                        cab.setText("Servidor FTP: debes rellenar el campo de texto");
