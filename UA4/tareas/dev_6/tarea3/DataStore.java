...
public class DataStore {
	...
	public void udtPerson(String nombreClave, Person person){
		personMap.replace(nombreClave, person);
	}
	public void delPerson(String nombreClave, Person person){
		personMap.remove(nombreClave, person);
	}
